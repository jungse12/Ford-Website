...
class simulation_model():
    def __init__(self):
        ...
        'costOfElectricity'      : lambda t: 0.0688,
        'costOfElectricityPerSlbKwh'      : lambda t: self.memoize('electricityPerKwh', t) * self.memoize('costOfElectricityWithIncrease', t) / ( 1.0 + self.memoize('technicallyFeasibleBatteriesFraction', t) ),
        'costOfElectricityWithIncrease'      : lambda t: self.memoize('costOfElectricity', t) + self.memoize('increaseInCostOfElectricityOverYear', t),
        'costOfLaborPerHour'      : lambda t: ( (0.0) if ( t  < self.memoize('startYearForReman', t)) else (self.memoize('maxCostOfLaborAtFacility', t) / self.memoize('numberOfLaborHoursInFacility', t)) ),
        'costOfLaborPerHourPossible'      : lambda t: ( (0.0) if ( t  < self.memoize('startYearForReman', t)) else (( ( (( ( (self.memoize('maxCostOfLabor', t)) if (self.memoize('costOfLaborPerHour', t) > self.memoize('maxCostOfLabor', t)) else (self.memoize('costOfLaborPerHour', t)) ) )) if (self.memoize('costOfLaborPerHour', t) > self.memoize('minCostOfLabor', t)) else (self.memoize('minCostOfLabor', t)) ) )) ),
        ...
        'increaseInCostOfElectricityOverYear'      : lambda t: self.memoize('costOfElectricity', t) * (  t  - 2019.0 ) * self.memoize('percentageIncreaseInCostOfElectricity', t) / ( 32.0 ),
        ...
        'laborOverheadPercent'      : lambda t: 0.65,
        ...
        'maxCostOfLabor'      : lambda t: 20.97 * 1.5,
        'maxCostOfLaborAtFacility'      : lambda t: self.memoize('remanSlb', t) * self.memoize('maxCostOfLaborPerSlbKwh', t),
        'maxCostOfLaborPerSlbKwh'      : lambda t: ( self.memoize('allowableMaxCostWithoutOverheads', t) - self.memoize('totalCostPerSlbKwhNoLabor', t) ) / ( 1.0 + self.memoize('laborOverheadPercent', t) ),
        'minCostOfLabor'      : lambda t: 20.97 * 0.5,
        ...
        'numberOfLaborHoursInFacility'      : lambda t: self.memoize('numberOfHoursPerYearPerLaborer', t) * self.memoize('minLaborNeeded', t),
        ...
        'overheadAndLaunchCosts'      : lambda t: ( 0.05 * self.memoize('costOfMaterialsPerSlbKwh', t) ),
        'percentageIncreaseInCostOfElectricity'      : lambda t: 0.02,
        ...
        'totalCostPerSlbKwhNoLabor'      : lambda t: self.memoize('transportationCostsPerSlbKwh', t) + self.memoize('costOfRemanCapacityPerSlbKwh', t) + self.memoize('costOfElectricityPerSlbKwh', t) + self.memoize('costOfMaterialsPerSlbKwh', t),
        ...
        self.converters = ['additionOverNYears',   'allowableMaxCost',   'allowableMaxCostWithoutOverheads',   'allowableProfit%',   'aluminumAfterRecycl',   'aluminumDemandModified',   'aluminumFraction',   'aluminumIn',   'aluminumRe',   'bevBatteryEnergy',   'bevBatteryEnergyInPerYear',   'bevBatteryEnergyOutPerYear',   'cobaltAfterRecycl',   'cobaltDemandModified',   'cobaltFraction',   'cobaltIn',   'cobaltRe',   'collectedeolb',   'collectionefficiency',   'copperAfterRecycl',   'copperDemandModified',   'copperFraction',   'copperIn',   'copperRe',   'costOfElectricity',   'costOfElectricityPerSlbKwh',   'costOfElectricityWithIncrease',   'costOfLaborPerHour',   'costOfLaborPerHourPossible',   'costOfMaterialsConstantBasedOnMassPerKwh',   'costOfMaterialsConstantPerKwh',   'costOfMaterialsOthersPerKwh',   'costOfMaterialsPerSlbKwh',   'costOfRemanCapacity',   'costOfRemanCapacityPerSlbKwh',   'costOfRemanCapacityTotal',   'electricityPerKwh',   'eolRecyclingValue',   'hybBatteryEnergy',   'hybBatteryEnergyInPerYear',   'hybBatteryEnergyOutPerYear',   'increaseInCostOfElectricityOverYear',   'ironAfterRecycl',   'ironDemandModified',   'ironFraction',   'ironIn',   'ironRe',   'kwh/kg',   'laborInFacility',   'laborOverheadPercent',   'licoo2Fraction',   'lifepo4Fraction',   'limn2o4Fraction',   'lithiumAfterRecycl',   'lithiumDemandModified',   'lithiumFraction',   'lithiumIn',   'lithiumRe',   'manganeseAfterRecycl',   'manganeseDemandModified',   'manganeseFraction',   'manganeseIn',   'manganeseRe',   'maxCostOfLabor',   'maxCostOfLaborAtFacility',   'maxCostOfLaborPerSlbKwh',   'minCostOfLabor',   'minLaborNeeded',   'modifiedLibDemand',   'nickelAfterRecycl',   'nickelDemandModified',   'nickelFraction',   'nickelIn',   'nickelRe',   'nmcFraction',   'numberOfHoursPerYearPerLaborer',   'numberOfLaborHoursInFacility',   'numberOfLaborersNeeded',   'numberOfShifts',   'outputPerHour',   'outputPerHourKwh',   'overheadAndLaunchCosts',   'percentageIncreaseInCostOfElectricity',   'percentageIncreaseInTransportationCost',   'phev10BatteryEnergy',   'phev10BatteryEnergyInPerYear',   'phev10BatteryEnergyOutPerYear',   'phev40BatteryEnergy',   'phev40BatteryEnergyInPerYear',   'phev40BatteryEnergyOutPerYear',   'ppEa',   'ppGp',   'ppTotal',   'recycledMaterialValue',   'recycledMaterialValueIn2020',   'recycledMaterialValuePercentIncrease',   'recycledeolb',   'remanSlb',   'remanSlbPossible',   'sellingPriceOfSlb',   'slbTonnes',   'slbdemand',   'startYearForReman',   'startYearForReman1',   'steelAfterRecycl',   'steelDemandModified',   'steelFraction',   'steelIn',   'steelRe',   'sumTotalCapEolBat',   'sumTotalCapInBat',   'technicallyFeasibleBatteriesFraction',   'technicallyFeasibleCollectedeolb',   'tonnePerSlbKwh',   'totalBevOut',   'totalCostPerSlbKwhNoLabor',   'totalEvBatteryEnergyPerYear',   'totalHybOut',   'totalLibDemand',   'totalPhev10Out',   'totalPhev40Out',   'totalSlbOut',   'transporationCostPerMile',   'transportCostPerKwh',   'transportDistanceFromRemanCapacity',   'transportDistanceMinInput',   'transportDistancePossible',   'transportTruckTonnage',   'transportationCostsPerMileForTheYear',   'transportationCostsPerSlbKwh',   'transportationCostsPerTonmile',   'updf',   'updfEa',   'updfGp',   'usedProductDiscountFactor',   'valueOfThroughputNewBattery',   'valueOfThroughputOldBattery',   'valueParameter',   'yearOfSwitchFromEaToGp',   'yearOfSwitchFromEaToGp1'  ]
