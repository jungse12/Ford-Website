...
class simulation_model():
    def __init__(self):
        ...
        'allowableMaxCost'      : lambda t: self.memoize('allowableMaxCostWithOverheads', t) * ( 1.0 + self.memoize('allowableProfit%', t) ),
        'allowableMaxCostWithOverheads'      : lambda t: self.memoize('totalCostPerSlbKwh', t) + self.memoize('overheadAndLaunchCosts', t),
        ...
        'eolValueFromRemanufacturing'      : lambda t: ( (( self.memoize('sellingPriceOfSlb', t) - self.memoize('allowableMaxCost', t) ) * self.memoize('remanSlb', t) / 1000000.0) if ( t  > self.memoize('startYearForReman', t)) else (0.0) ),
        ...
        'totalCostPerSlbKwh'      : lambda t: self.memoize('costOfLaborPerSlbKwh', t) + self.memoize('costOfRemanCapacityPerSlbKwh', t) + self.memoize('costOfElectricityPerSlbKwh', t) + self.memoize('costOfMaterialsPerSlbKwh', t) + self.memoize('transportationCostsPerSlbKwh', t),
        'totalEolValue'      : lambda t: ( (self.memoize('eolRecyclingValue', t) + self.memoize('eolValueFromRemanufacturing', t)) if ( t  > self.memoize('startYearForReman', t)) else (0.0) ),
