...
class simulation_model():
    def __init__(self):
        ...
        'totalCostPerSlbKwhNoTransport'      : lambda t: self.memoize('costOfLaborPerSlbKwh', t) + self.memoize('costOfRemanCapacityPerSlbKwh', t) + self.memoize('costOfElectricityPerSlbKwh', t) + self.memoize('costOfMaterialsPerSlbKwh', t),
        ...
        'transportCostPerKwh'      : lambda t: self.memoize('allowableMaxCostWithoutOverheads', t) - self.memoize('totalCostPerSlbKwhNoTransport', t),
        'transportDistanceFromRemanCapacity'      : lambda t: 2524.2424 - ( self.memoize('remanCapacity', t) / 20625.0 ),
        'transportDistancePerKwh'      : lambda t: ( (0.0) if ( t  < self.memoize('startYearForReman', t)) else (self.memoize('transportationCostsPerSlbKwh', t) / ( ( self.memoize('transportationCostsPerTonmile', t) ) * self.memoize('tonnePerSlbKwh', t) )) ),
        'transportDistancePossible'      : lambda t: max([100.0 , min([self.memoize('transportDistancePerKwh', t) , self.memoize('transportDistanceFromRemanCapacity', t)])]),
        ...
        self.converters = ['additionOverNYears',   'allowableMaxCost',   'allowableMaxCostWithoutOverheads',   'allowableProfit%',   'aluminumAfterRecycl',   'aluminumDemandModified',   'aluminumFraction',   'aluminumIn',   'aluminumRe',   'bevBatteryEnergy',   'bevBatteryEnergyInPerYear',   'bevBatteryEnergyOutPerYear',   'cobaltAfterRecycl',   'cobaltDemandModified',   'cobaltFraction',   'cobaltIn',   'cobaltRe',   'collectedeolb',   'collectionefficiency',   'copperAfterRecycl',   'copperDemandModified',   'copperFraction',   'copperIn',   'copperRe',   'costOfElectricity',   'costOfElectricityPerSlbKwh',   'costOfElectricityWithIncrease',   'costOfLaborInFacility',   'costOfLaborPerHour',   'costOfLaborPerSlbKwh',   'costOfLaborPerSlbKwhWithoutIncrease',   'costOfMaterialsConstantBasedOnMassPerKwh',   'costOfMaterialsConstantPerKwh',   'costOfMaterialsOthersPerKwh',   'costOfMaterialsPerSlbKwh',   'costOfRemanCapacity',   'costOfRemanCapacityPerSlbKwh',   'costOfRemanCapacityTotal',   'electricityPerKwh',   'eolRecyclingValue',   'hybBatteryEnergy',   'hybBatteryEnergyInPerYear',   'hybBatteryEnergyOutPerYear',   'increaseInCostOfElectricityOverYear',   'increaseInLaborCost',   'ironAfterRecycl',   'ironDemandModified',   'ironFraction',   'ironIn',   'ironRe',   'kwh/kg',   'laborInFacility',   'licoo2Fraction',   'lifepo4Fraction',   'limn2o4Fraction',   'lithiumAfterRecycl',   'lithiumDemandModified',   'lithiumFraction',   'lithiumIn',   'lithiumRe',   'manganeseAfterRecycl',   'manganeseDemandModified',   'manganeseFraction',   'manganeseIn',   'manganeseRe',   'minLaborNeeded',   'modifiedLibDemand',   'nickelAfterRecycl',   'nickelDemandModified',   'nickelFraction',   'nickelIn',   'nickelRe',   'nmcFraction',   'numberOfHoursPerYearPerLaborer',   'numberOfLaborersNeeded',   'numberOfShifts',   'outputPerHour',   'outputPerHourKwh',   'overheadAndLaunchCosts',   'percentageIncreaseInCostOfElectricity',   'percentageIncreaseInLaborCost',   'percentageIncreaseInTransportationCost',   'phev10BatteryEnergy',   'phev10BatteryEnergyInPerYear',   'phev10BatteryEnergyOutPerYear',   'phev40BatteryEnergy',   'phev40BatteryEnergyInPerYear',   'phev40BatteryEnergyOutPerYear',   'ppEa',   'ppGp',   'ppTotal',   'recycledMaterialValue',   'recycledMaterialValueIn2020',   'recycledMaterialValuePercentIncrease',   'recycledeolb',   'remanSlb',   'remanSlbPossible',   'sellingPriceOfSlb',   'slbTonnes',   'slbdemand',   'startYearForReman',   'startYearForReman1',   'steelAfterRecycl',   'steelDemandModified',   'steelFraction',   'steelIn',   'steelRe',   'sumTotalCapEolBat',   'sumTotalCapInBat',   'technicallyFeasibleBatteriesFraction',   'technicallyFeasibleCollectedeolb',   'tonnePerSlbKwh',   'totalBevOut',   'totalCostPerSlbKwhNoTransport',   'totalEvBatteryEnergyPerYear',   'totalHybOut',   'totalLibDemand',   'totalPhev10Out',   'totalPhev40Out',   'totalSlbOut',   'transporationCostPerMile',   'transportCostPerKwh',   'transportDistanceFromRemanCapacity',   'transportDistancePerKwh',   'transportDistancePossible',   'transportTruckTonnage',   'transportationCostsPerMileForTheYear',   'transportationCostsPerSlbKwh',   'transportationCostsPerTonmile',   'updf',   'updfEa',   'updfGp',   'usedProductDiscountFactor',   'valueOfThroughputNewBattery',   'valueOfThroughputOldBattery',   'valueParameter',   'yearOfSwitchFromEaToGp',   'yearOfSwitchFromEaToGp1'  ]
